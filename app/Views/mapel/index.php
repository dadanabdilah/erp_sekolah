                                ...
                                <?php $no = 1; foreach($Mapel as $key){ ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?= base_url('mapel/delete/' . $key->id)  ?>" class="btn btn-warning btn-sm" >Hapus</button>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
...
<div class="modal fade" id="modal-default">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form action="<?= base_url('mapel/insert') ?>" method="POST">
			...
			<form action="<?= base_url('mapel/update') ?>" method="POST">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="mapel" value="<?= $key->mapel ?>" />
                    </div>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
