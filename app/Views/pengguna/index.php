                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="jabatan" class="form-control select2"style="width: 100%;">
                            ...
                            <option value="Kepala_Sekolah" <?= $key->jabatan == "Kepala_Sekolah" ? "selected" : "" ; ?>>Kepala Sekolah</option>
                            <option value="Keuangan" <?= $key->jabatan == "Keuangan" ? "selected" : "" ; ?> >Keuangan</option>
                            <option value="Wali_Kelas" <?= $key->jabatan == "Wali_Kelas" ? "selected" : "" ; ?>>Wali Kelas</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Password</label>
                        <input class="form-control" type="password" name="password" value="<?= $key->password ?>" />
